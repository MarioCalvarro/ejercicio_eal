...
\begin{sol}
    ...
    \]
    y sus opuestos. Naturalmente, $u,v \in K_f$\footnote{$K_f$ denota el cuerpo de descomposición de $f$ sobre $K$.} lo que quiere decir, a su vez, que $d := \sqrt{a^2 - 4b} = 2u^2 + a \in K_f$. Al ser $d$ raíz de $\mathrm{t}^2 - \left( a^2 - 4b \right)$, su polinomio irreducible sobre $K$ lo dividirá y, por tanto, tendrá grado menor o igual a $2$. Esto nos permite asegurar entonces que $d \in K\left( \sqrt{b} \right)$. Por lo tanto, podemos factorizar $f$ como:
    \begin{align*}
        ...
        &= \left( t^2 + \frac{a}{2} - \frac{d}{2} \right)\left( \mathrm{t}^2 + \frac{a}{2} + \frac{d}{2} \right)
    \end{align*}
\end{sol}
